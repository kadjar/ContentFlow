...
var ContentFlowGlobal = {
	...
	scriptElement: null,
    isTouch: Windows.Devices.Input.TouchCapabilities().touchPresent,
...
var ContentFlowGUIElement = function (CFobj, element) {
	...
	element.makeDraggable = function (onDrag, beforeDrag, afterDrag) {
		...
		this.startDrag = function (event) {
			...
			if (ContentFlowGlobal.isTouch) {

			    window.addEvent('MSPointerMove', onDrag, false);
			    window.addEvent('MSPointerUp', stopDrag, false);
			} else {
		...
		if (ContentFlowGlobal.isTouch) {
		    this.addEvent('MSPointerDown', startDrag, false);
		} else {
...
ContentFlowItem.prototype = {
	...
	initClick: function () {
	    ...
	    ContentFlowGlobal.isTouch ? this[this._activeElement].addEvent('click', cItem, false) : this[this._activeElement].addEvent('mouseup', cItem, false);
	}, 
  initTouch: function () {
    var tItem = this.clickItem;
    this[this._activeElement].addEvent('MSPointerDown', tItem, false);
  },
